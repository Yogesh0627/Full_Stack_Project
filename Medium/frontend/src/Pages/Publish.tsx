...
const Publish = () => {
  ...
  const {title,content} = publishBlog
  ...
  return( 
    <div>
      ...
      <div className="max-w-screen-lg w-full">
        <input onChange={handleChange} name='title' value={title} type="text" className="w-full focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Title" />

        <TextEditor onChange={handleTextChange} value={content} name="content" />
